---
title: "2019-09-10 - Análise de Resíduos em Modelos de Regressão Linear"
date: 2019-09-10
---
...
Neste post vou calcular uma regressão linear simples e analisar os resíduos ver se as premissas **iii** e **iv** estão sendo atendidas. Para começar, vamos trazer os pacotes necessários no R:
...
```{r}
df <- read.csv(file = "https://raw.githubusercontent.com/FranciscoPiccolo/franciscopiccolo.github.io/master/datasets/2019-09-05-residual_analysis_on_linear_regression_models/dataset_1.csv", 
               sep = ";", 
               dec = ",")
```
